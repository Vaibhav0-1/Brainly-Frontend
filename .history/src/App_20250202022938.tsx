...
function App()  {
  ...
  return (
    <div className="p-4">
      {modalOpen && <CreateContentModal open={modalOpen} onClose={() => setModalOpen(false)} 
      />}

      <div className="flex justify-end gap-4">
      <Button onClick={() => {
        setModalOpen(true)
      }}variant='primary' text='Add Content' size='sm' startIcon={<PlusIcon size={'md'}/>} onClick={() => setModalOpen(true)}></Button>
