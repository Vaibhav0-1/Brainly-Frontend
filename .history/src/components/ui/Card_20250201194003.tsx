...
export function Card(){
    return <div>
        <div className="p-4 bg-white rounded-md shadow-md border-gray-200 max-w-72 border">
            ...
            <blockquote class="twitter-tweet"><p lang="en" dir="ltr">The best way to improve at anything:<br><br>Start before you are ready.<br>Fix things as you go.<br>Show up daily.</p>&mdash; Pratham (@Prathkum) <a href="https://twitter.com/Prathkum/status/1885389575591498056?ref_src=twsrc%5Etfw">January 31, 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
        </div>
    </div>
}