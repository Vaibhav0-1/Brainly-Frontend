...
export function CreateContentModal({open, onClose}: { open: boolean; onClose: () => void }){
    ...
    return <div className="w-screen h-screen bg-slate-500 fixed top-0 left-0 opacity-60 flex justify-center" ref={modalRef}>
        <div className="flex flex-col justify-center shadow-md rounded">
            <span className="bg-white opacity-100 p-4 rounded" /// <reference path="" />
            >
