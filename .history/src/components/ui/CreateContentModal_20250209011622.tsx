...
export function CreateContentModal({open, onClose}: { open: boolean; onClose: () => void }){
  ...
  function addContent(){
    ...
    return <div className="w-screen h-screen bg-purple-200 fixed top-0 left-0 opacity-100 flex justify-center">
        <div className="flex flex-col justify-center rounded-2xl" ref={modalRef}>
